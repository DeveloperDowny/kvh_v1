import { Box, Text, TableContainer, Table, Th, Thead, Tbody, Badge, Flex, Divider, Stack, HStack, Tag } from '@chakra-ui/react'
        ...
        <Box w={'full'} h={'full'} >
            <TableContainer>
                <Table>
                    ...
                    <Tbody display={'flex'} justifyContent={'center'} alignItems={'center'} mt={8}>
                        <Stack align={'center'}>
                            ...
                            <Divider />
                            <Flex gap={4} mt={3} flexWrap={'wrap'} width={'75%'} justify={'space-evenly'} >
                                <Box display={'inline'}>
                                    Balance:
